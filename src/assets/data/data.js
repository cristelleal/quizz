export const data = [
  {
    question:
      "Quel geste de secours est recommandé en cas d'obstruction des voies respiratoires chez une personne adulte et consciente ?",
    option1: 'La position latérale de sécurité (PLS)',
    option2: 'Le massage cardiaque',
  ...
  },
  {
    ...
    option1: 'Danger vital, réel, imminent et contrôlable',
    option2: 'Danger réel, vital, imminent et non contrôlable',
  ...
  {
    question:
      'Comment reconnaître une obstruction des voies respiratoires chez une personne consciente ?',
    option1: "La personne n'arrive pas à s'arrêter de tousser",
    option2: 'Elle ne respire pas',
  ...
  {
    question:
      "Que signifie l'acronyme PSC1 dans le contexte des gestes de secours en France ?",
    option1: 'Protection et Sauvetage Civique de niveau 1',
    option2: 'Premiers Secours Civiques de niveau 1',
  ...
  },
  {
    ...
    option1: 'Souffle court',
    option2: 'Une douleur irradiant vers la nuque et la mâchoire',
  ...
  },
  {
    ...
    option1: '2 massages / 30 insufflations',
    option2: '12 massages / 4 insufflations',
  ...
  },
  {
    ...
    option1: 'À tout le monde',
    option2: 'Aux personnes formées',
  ...
  },
  {
    ...
    option1: "L'activité électrique du cœur",
    option2: "L'activité cérébrale",
  ...
  {
    question:
      'Un défibrillateur autonome externe effectue une analyse toutes les :',
    option1: 'Deux minutes',
    option2: 'Cinq minutes',
  ...
  {
    question:
      "Lors de l'utilisation du défibrillateur, je dois m'assurer que :",
    option1: 'La victime ne porte pas de pacemaker',
    option2: "La victime n'est pas allongée dans la neige",
    option3: 'Personne ne touche la victime au moment du choc',
    answer: 3,
    advice:
      "Pendant les analyses du défibrillateur, il est crucial de ne pas toucher la victime, afin d'éviter toute perturbation de l'analyse. De plus, lors de l'administration du choc électrique, tout le monde doit se tenir à distance, car un contact avec la victime au moment du choc présente un risque d'électrocution. La sécurité et l'efficacité de l'intervention sont ainsi préservées.",
  },
];
